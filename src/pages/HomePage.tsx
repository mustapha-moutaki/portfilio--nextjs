  ...
  return (
    <Layout>
      <div className="min-h-screen w-full relative flex flex-col justify-center items-center px-4 md:px-10 lg:px-20">
        ...
        >
          <Button asChild variant="ghost" className="border border-cyan/20 hover:bg-cyan/10">
            <Link to="/contact">
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div ref={headingRef} className="text-4xl md:text-5xl lg:text-7xl font-mono font-bold mb-6 overflow-hidden">
          ...
          <div ref={subHeadingRef} className="mt-12 max-w-lg mx-auto text-lg text-muted-foreground">
            Building innovative digital experiences with creativity and technical excellence.
          </div>
        </div>
